...
<header class="header">
    ...
    <div class="header__content container">
        <div class="tour-card">
            ...
            <button class="tour-card__button">Оформить тур</button>
        </div>
    </div>
</header>
...
<section class="about-tour container">
    ...
    <div class="about-tour__content">
        ...
        <form class="buy-tour-card" style="background-image: url('https://i.ibb.co/XyXJ3jL/glodi-miessi-MUYe-ZCo4-BB0-unsplash.jpg')" action="{{ route('add-basket') }}" method="post">
            @csrf
            ...
            <input type="hidden" name="city" value="@yield("City")">
            <input type="hidden" name="price" value="@yield("Price")">
            <button class="buy-tour-card__button" type="submit">Добавить в корзину</button>
        </form>
    </div>
</section>
